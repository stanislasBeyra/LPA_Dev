    ...
    public function vendorgister(Request $request)
    {
        try {
            ...
            $validated = $request->validate([
                ...
                'businessemail'=>'nullable|email|unique:vendors',
                ...
                'businessemail.email' => 'The email must be a valid email address.',
                'businessemail.unique'=>'The businessemail has already been taken.',
