    ...
    <div class="container-fluid pt-4">
        ...
        <section>
            <div class="container-fluid py-5">
                @php
                    $imageUrl = Upload::getAbosoluteUrl('avatars', Auth::user()->avatar);
                @endphp
                    ...
                    <div class="modal-dialog modal-dialog-centered text-center d-flex justify-content-center">
                        <div class="modal-content w-75">
                            <div class="modal-body p-4">
                                <img src="{{ Auth::user()->avatar ? $imageUrl : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}"
                                    alt="avatar"
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-4">
                            <div class="card-body text-center">
                                <!-- L'image cliquable -->
                                <img src="{{ Auth::user()->avatar ? $imageUrl : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}"
                                    alt="avatar" class="rounded-circle shadow img-fluid"
                                    style="width: 130px; height:130px; cursor: pointer;" id="avatar-image">
                                ...
                                <div class="d-flex justify-content-center mb-2">
                                    <button type="button" class="btn btn-primary" data-mdb-toggle="modal"
                                        data-mdb-target="#staticBackdrop5">Reset Password</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <p class="text-muted mb-0">{{ Auth::user()->firstname }}
