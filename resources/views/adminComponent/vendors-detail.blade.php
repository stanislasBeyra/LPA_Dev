...
@section('content')
            ...
            <section>
                <div class="container-fluid py-5">
                        ...
                        <div class="modal-dialog modal-sm">
                            <div class="modal-content">
                                <div class="modal-header bg-warning d-flex justify-content-center w-100">
                                    <h5 class="modal-title text-white text-center" id="deleteConfirmationModalLabel">Reset
                                        Confirmation</h5>
                                </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('vendor.resetPassword') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-warning btn-block" id="editButton">
                                            ...
                                            <div id="editSpinner" class="spinner-border text-white"
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header bg-warning justify-content-center">
                                    <h5 class="modal-title text-white" id="exampleModalLabel">Update Username or Password
                                    </h5>
                                </div>
                                <form action="{{ route('update.vendor.info') }}" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="row justify-content-center">
                                            <div class="form-outline" style=" display:none;">
                                                <input type="hidden" name="vendorsid" value="{{ $user->id }}"
                                                    class="form-control" />
                                            ...
                                            <div class="col-auto">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="reset_password"
                                                        value="true" id="resetPassword" />
                                                    <label class="form-check-label" for="resetPassword">Reset
                                                        password</label>
                                                </div>
                                            </div>
                                            <div class="col-auto"
                                                @if (auth()->user()->role == 5) style="display: none;" @endif>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" name="reset_username"
                                                        value="true" id="resetUsername" />
                                                    <label class="form-check-label" for="resetUsername">Reset
                                                        username</label>
                                                </div>
                                            </div>
                                            <div class="col-auto">
                                                <div class="form-check"
                                                    @if (auth()->user()->role == 5) style="display: none;" @endif>
                                                    <input class="form-check-input" type="checkbox" name="reset_all"
                                                        value="true" id="resetAll" />
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-warning" id="resetPasswordButton"
                                            style="display: none;">Reset Password</button>
                                        <button type="submit" class="btn btn-warning" id="resetUsernameButton"
                                            style="display: none;">Reset Username</button>
                                        <button type="submit" class="btn btn-warning" id="resetAllButton"
                                            style="display: none;">Reset All</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            @php
                                        $imageUrl = Upload::getAbosoluteUrl(
                                            'avatars',
                                            $user->avatar,
                                        );
                                    @endphp
                            ...
                            <div class="card mb-4 animate__animated animate__zoomIn">
                                <div class="card-body text-center">
                                    <div class="position-relative d-inline-block">
                                        <img src="{{ $user->avatar ? $imageUrl : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}"
                                            alt="avatar" class="rounded-circle shadow img-fluid clickable-avatar"
                                            style="width: 130px; height:130px; cursor: pointer;"
                                            onclick="document.getElementById('avatar-input').click()">

                                        <form action="{{ route('admin.vendor.update-avatar') }}" method="POST"
                                            enctype="multipart/form-data" id="avatar-form">
                                            @csrf
                                            <input type="hidden" name="vendor_id" value="{{ $user->id }}">
                                            <input type="file" name="avatar" id="avatar-input"
                                                style="display: none;" accept="image/*" onchange="previewAvatar(event)">
                                            ...
                                            <div id="save-avatar-section" style="display: none;" class="mt-2">
                                                ...
                                                <button type="button" class="btn btn-outline-danger shadow btn-sm ml-2"
                                                    onclick="cancelAvatarChange()">Cancel</i></button>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    @php
                                        $imageUrl = Upload::getAbosoluteUrl(
                                            'documents',
                                            $user->vendor->businesscertificate,
                                        );

                                        // Récupérer et décoder les fichiers depuis le modèle Vendor
                                        $businessCertificates = json_decode(
                                            $user->vendor->businesscertificate ?? null,
                                            true,
                                        );
                                    @endphp
                                            ...
                                            <div class="carousel-inner">
                                                @foreach ($businessCertificates as $index => $certificate)
                                                    @php
                                                        ...
                                                        // $filePath = Storage::disk('minio')->url('documents/' . $certificate);
                                                        $filePath = Upload::getAbosoluteUrl('documents', $certificate);
                                                    @endphp
                                                    ...
                                                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                                        @if ($fileExtension == 'pdf')
                                                            ...
                                                            <object data="{{ $filePath }}" type="application/pdf"
                                                                ...
                                                                <p>Votre navigateur ne supporte pas l'affichage des fichiers
                                                                    PDF.
                                                                    <a href="{{ $filePath }}"
                                                                        target="_blank">Téléchargez le fichier</a>.
                                                                </p>
                                                            </object>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @if (!empty($taxCertificates))
                                        <!-- Carousel wrapper -->
                                        <div id="carouselTaxCertificate" class="carousel slide carousel-fade"
                                            data-mdb-ride="carousel">
                                            <!-- Indicators -->
                                            <div class="carousel-indicators">
                                                @foreach ($taxCertificates as $index => $certificate)
                                                    <button type="button" data-mdb-target="#carouselTaxCertificate"
                                                        data-mdb-slide-to="{{ $index }}"
                                                        class="{{ $index == 0 ? 'active' : '' }}"
                                                        aria-current="{{ $index == 0 ? 'true' : 'false' }}"
                                                        aria-label="Slide {{ $index + 1 }}"></button>
                                            ...
                                            <!-- Controls -->
                                            <button class="carousel-control-prev text-danger" type="button"
                                                data-mdb-target="#carouselTaxCertificate" data-mdb-slide="prev">
                                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">previous</span>
                                            </button>
                                            <button class="carousel-control-next text-danger" type="button"
                                                data-mdb-target="#carouselTaxCertificate" data-mdb-slide="next">
                                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">next</span>
                                            </button>
                                        </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @if (!empty($passportOrID))
                                        <!-- Carousel wrapper -->
                                        <div id="carouselPassportOrID" class="carousel slide carousel-fade"
                                            data-mdb-ride="carousel">
                                            <!-- Indicators -->
                                            <div class="carousel-indicators">
                                                @foreach ($passportOrID as $index => $certificate)
                                                    <button type="button" data-mdb-target="#carouselPassportOrID"
                                                        data-mdb-slide-to="{{ $index }}"
                                                        class="{{ $index == 0 ? 'active' : '' }}"
                                                        aria-current="{{ $index == 0 ? 'true' : 'false' }}"
                                                        aria-label="Slide {{ $index + 1 }}"></button>
                                                ...
                                                @foreach ($passportOrID as $index => $certificate)
                                                    ...
                                                    <div class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                                        ...
                                                        @elseif(in_array($fileExtension, ['jpg', 'jpeg', 'png', 'gif', 'bmp', 'svg']))
                                                            ...
                                                            <img src="{{ $filePath }}" class="d-block w-100"
                                                                style="height: 600px; width: auto; object-fit: contain;"
                                                                alt="Passport or Government-Issued ID">
                                                        @else
                                                            <p class="text-muted mb-0">No valid document found</p>
                                                        @endif
                                                    </div>
                                            ...
                                            <!-- Controls -->
                                            <button class="carousel-control-prev text-danger" type="button"
                                                data-mdb-target="#carouselPassportOrID" data-mdb-slide="prev">
                                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">previous</span>
                                            </button>
                                            <button class="carousel-control-next text-danger" type="button"
                                                data-mdb-target="#carouselPassportOrID" data-mdb-slide="next">
                                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                                <span class="visually-hidden">next</span>
                                            </button>
                                        </div>
    ...
    <script>
        ...
        function cancelAvatarChange() {
            ...
            image.src =
                "{{ $user->avatar ? asset('app/' . $user->avatar) : 'https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp' }}";
