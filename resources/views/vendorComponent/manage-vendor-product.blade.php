...
@section('content')
    <div class="container-fluid pt-4">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <button type="button" class="btn btn-primary fs-7" data-mdb-button-init data-mdb-ripple-init
                class="btn btn-primary" data-mdb-modal-init data-mdb-target="#staticBackdrop1">
                add products
            </button>
        </div>
        <!-- Button trigger modal -->
                            ...
                            <div class="d-flex flex-column mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" name="ProductImage[]" id="ProductImage"
                                        class="form-control d-none" multiple accept=".jpeg,.jpg,.png" />
                                </div>
                            ...
                            <tbody>
                                @foreach ($products as $key => $product)
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="{{ $imageUrl }}"
                                                height="60" width="60" class="shadow  rounded-3"
                                                alt="" /></td>
                                        ...
                                        <td>
                                            ...
                                            <button type="button" class="btn btn-outline-primary btn-sm"
                                                data-mdb-button-init data-mdb-ripple-init data-mdb-modal-init
                                                data-mdb-target="#staticBackdrop3"
    ...
    <!--Edit Modal -->
    <div class="modal fade" id="staticBackdrop3" tabindex="-1" aria-labelledby="exampleModalLabel3"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form method="POST" action="{{ route('update.product') }}">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-outline-primary" id="editButton">
                                ...
                                <div id="editSpinner" class="spinner-border text-primary"
                                    style="display: none; width: 1.5rem; height: 1.5rem;" role="status">
                                    <span class="visually-hidden">Loading...</span>
                                </div>
                            </button>
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active">
                                <img src="" class="d-block "
                                    style="width: 100%; height: 250px; object-fit: cover;" alt="Motorbike Smoke" />
                            ...
                            <div class="carousel-item">
                                <img src="" class="d-block"
                                    style="width: 100%; height: 250px; object-fit: cover;" alt="Mountaintop" />
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 id="productDetailName"></h5>
                                </div>
                            </div>
                            ...
                            <div class="carousel-item">
                                <img src="" class="d-block"
                                    style="width: 100%; height: 250px; object-fit: cover;" alt="Woman Reading a Book" />
                                <div class="carousel-caption d-none d-md-block">
                                    <h5 id="productDetailName"></h5>
    ...
    <script>
        ...
        //     document.querySelector("#productDetailcategorie").textContent = productData.category
        //     .categories_name; // Exemple de revenu
        ...
        // Injecter directement l'URL de base de ton serveur MinIO
        ...
        document.querySelector("#productDetailcategorie").textContent = productData.category.categories_name; // Exemple de catégorie
        ...
        document.getElementById('ProductImage').addEventListener('change', function(event) {
            ...
            if (files.length > 3) {
                const alertMessage =
                    `<div class="alert alert-danger">You can only upload a maximum of 3 images.</div>`;
